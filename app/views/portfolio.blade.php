    ...
    <div class="container">
        ...
        <div class="row featurette">
            <div class="col-md-7">
                ...
                <a href="https://github.com/BobFromAccounting/whackamole" target="_blank"><img src="/img/GitHub.png"><p>Check it out on GitHub</p></a>
            </div>
            <div class="col-md-5">
                <a href="{{{ action('HomeController@showMario') }}}" target="_blank"><img class="featurette-image img-responsive center-block" src="/img/mariosescapeplan.png"></a>
            </div>
        </div>
        ...
        <div class="row featurette">
            <div class="col-md-7 col-md-push-5">
                ...
                <a href="https://github.com/BobFromAccounting/simplesimon.dev" target="_blank"><img src="/img/GitHub.png"><p>Check it out on GitHub</p></a>
            </div>
            <div class="col-md-5 col-md-pull-7">
                <a href="{{{ action('HomeController@showSimon') }}}" target="_blank"><img class="featurette-image img-responsive center-block" src="/img/simplesimon.png"></a>
            </div>
        </div>
        ...
        <div class="row featurette">
            <div class="col-md-7">
                ...
                <a href="https://github.com/BobFromAccounting/codeup.dev/blob/master/public/animate_exercise.html" target="_blank"><img src="/img/GitHub.png"><p>Check it out on GitHub</p></a>
                
            </div>
            <div class="col-md-5">
                <a href="{{{ action('HomeController@showAnimate') }}}" target="_blank"><img class="featurette-image img-responsive center-block" src="/img/animate.png"></a>
            </div>
        </div>
        ...
        <div class="row featurette">
            <div class="col-md-7 col-md-push-5">
                ...
                <a href="https://github.com/BobFromAccounting/codeup.dev/blob/master/public/jquery_animate_fun.html" target="_blank"><img src="/img/GitHub.png"><p>Check it out on GitHub</p></a>
                
            </div>
            <div class="col-md-5 col-md-pull-7">
                <a href="{{{ action('HomeController@showSnorlax') }}}" target="_blank"><img class="featurette-image img-responsive center-block" src="/img/snorlax.png"></a>
            </div>
        </div>
        ...
        <div class="row featurette">
            <div class="col-md-7">
                ...
                <a href="https://github.com/BobFromAccounting/codeup.dev/blob/master/public/calculator.html" target="_blank"><img src="/img/GitHub.png"><p>Check it out on GitHub</p></a>
                
            </div>
            <div class="col-md-5">
                <a href="{{{ action('HomeController@showCalculator') }}}" target="_blank"><img class="featurette-image img-responsive center-block" src="/img/calculator.png"></a>
            </div>
        </div>
        ...
        <div class="row featurette">
            <div class="col-md-7 col-md-push-5">
                ...
                <a href="https://github.com/AdnormalOatmeal/AdnormalLister" target="_blank"><img src="/img/GitHub.png"><p>Check it out on GitHub</p></a>
                
            </div>
            <div class="col-md-5 col-md-pull-7">
                <a href="{{{ action('HomeController@showAdnormalGallery') }}}" target="_blank"><img class="featurette-image img-responsive center-block" src="/img/AdnormalAdlister.png"></a>
            </div>
        </div>
    </div>
@stop